...
# ---------------------------------------------------------------
# Site-wide disclaimer — renders at the bottom of EVERY tab
# ---------------------------------------------------------------
st.divider()
st.markdown(
    "<div style='padding:14px 18px;border-radius:10px;"
    "border:1px solid #E6A817;background:rgba(230,168,23,0.08);'>"
    "<b style='color:#E6A817;'>⚠️ Disclaimer — Read Before Acting</b>"
    "<div style='margin-top:8px;line-height:1.55;'>"
    "KSE Quantum is an <b>information and analysis tool only</b>. It is "
    "<b>not</b> an investment advisory service, and nothing shown here is "
    "financial advice, a recommendation, or a solicitation to buy or sell "
    "any security. All signals, scores, patterns, verdicts and data are "
    "generated automatically from public sources and may be delayed, "
